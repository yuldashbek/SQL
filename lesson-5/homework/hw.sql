...
SELECT count(distinct ProductName) as [Name]
	From Products

SELECT count(distinct Products) as [Client]
	From Products
...
SELECT iif(StockQuantity > 110, 'Yes','No') 
FROM Products
...
select *,
		iif vals > 1000, 'Expensive', iif(vals <= 1000, 'aff'
		from RangeValues
